<template>
  <div class="row w-100 justify-center items-center">
    <div class="col">
        ...
        <div class="column justify-center w-100">
          <div>
            <div class="column items-center">
              <q-input v-model="form.number" label="工號" class="q-py-md w-75">
      ...
      <div class="row">
        <span class="q-mx-auto q-mt-lg"
          >Copyright &copy; 2023 | 世間水食品股份有限公司 著作權所有
        </span>
      </div>
    </div>
  </div>
...
.q-btn{
  color: #fff;
  background: linear-gradient(to right, #3b82c2, #469ccb, #65c0d5);
}
